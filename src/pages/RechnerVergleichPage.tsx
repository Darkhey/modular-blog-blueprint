  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <link rel="canonical" href="https://sanierenundsparen.de/rechner-vergleich" />
      </Helmet>

      <CalculatorHero
        icon={Scale}
        title="Sanierungsmaßnahmen vergleichen"
        subtitle="Geben Sie Ihre Gebäudedaten ein und sehen Sie alle drei Sanierungsoptionen im direkten Vergleich – Kosten, Ersparnisse und Umweltwirkung."
        gradient="from-indigo-500 to-purple-500"
        breadcrumbs={[
          { label: 'Rechner', to: '/rechner' },
          { label: 'Maßnahmen-Vergleich' },
        ]}
      />
      ...
      <main id="rechner" tabIndex={-1} className="container max-w-6xl mx-auto px-4 py-8 space-y-8 scroll-mt-24">
        ...
        <CalculatorFaqSection
          ...
          breadcrumbs={[
            ...
            { name: 'Maßnahmen-Vergleich', url: 'https://sanierenundsparen.de/rechner-vergleich' },
          ]}
        />
      </main>
    </div>
